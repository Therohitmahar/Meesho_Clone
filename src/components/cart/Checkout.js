...
function Checkout() {
    ...
    const { state: { cart }, dispatch } = InfoState();
    ...
    return (
        <div style={{ display: "flex", margin: "auto", width: "90vw" }}>
            {cart.length > 0 && <div className="left-cart">
                ...
                <div className='mode-of-payment' style={{ display: "flex", flexDirection: "column", justifyContent: "center", }}>
                    <h2>Payment Mode</h2>
                    <h3 style={{ display: "flex", alignItems: "center", }}>
                        <FaRegMoneyBillAlt /><span>{" "}</span> <span style={{ color: "green" }}>Cash</span> on Delivery
                    </h3>
                </div>
            </div>}
