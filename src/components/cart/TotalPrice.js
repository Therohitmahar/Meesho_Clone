...
function TotalPrice({ handleSuccess, timer, continueTo, ContinueTitle, dispatch, justSaying }) {
    ...
    <div className="price-details">
      ...
      {justSaying === "false" ? "" : (
        <p className="just-saying">
          Clicking on 'Continue' will not deduct any money</p>)}
      <button onClick={() => {
        lateTimer();
        handleSuccess();
        timer();

      }}>{ContinueTitle}</button>
